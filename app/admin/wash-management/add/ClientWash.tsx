              ...
              <div className="invoice-content">
                <div className="invoice-detail-body">
                  <div className="invoice-detail-title">
                    ...
                    >
                      <FileUpload allowMultiple={true} maxFiles={1} />
                    </div>
                      ...
                      <div className="col-md-6">
                        ...
                        <div className="form-group row invoice-created-by">
                          ...
                          <div className="col-sm-9">
                            <select
                              name="country_code"
                              className="pcountry_code  form-control-sm"
                ...
                <div className="invoice-action-btn">
                  <div className="row">
                    <div className="col-xl-12 col-md-4">
                      <a href="#" className="btn btn-primary btn-send">
                        Send Invoice
                      </a>
                    </div>
                    <div className="col-xl-12 col-md-4">
                    ...
                    <div className="col-xl-12 col-md-4">
                      <a href="#" className="btn btn-success btn-download">
                        Save
                      </a>
                    </div>
                  </div>
